...
def run_benchmarks() -> list[BenchmarkResult]:
    ...
    time_ms = time_operation(isinstance_exact, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_parent, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_deep, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_abc, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_builtin, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_tuple, iterations=100_000)
    ...
    time_ms = time_operation(isinstance_false, iterations=100_000)
    ...
    def type_equals():
        return type(obj) == DerivedClass  # noqa: E721

    time_ms = time_operation(type_equals, iterations=100_000)
    ...
    time_ms = time_operation(type_is, iterations=100_000)
    ...
    time_ms = time_operation(type_builtin, iterations=100_000)
    ...
    time_ms = time_operation(type_in_tuple, iterations=100_000)
    ...
    time_ms = time_operation(issubclass_direct, iterations=100_000)
    ...
    time_ms = time_operation(issubclass_deep, iterations=100_000)
    ...
    time_ms = time_operation(issubclass_abc, iterations=100_000)
    ...
    time_ms = time_operation(hasattr_exists, iterations=100_000)
    ...
    time_ms = time_operation(hasattr_missing, iterations=100_000)
    ...
    time_ms = time_operation(hasattr_slots, iterations=100_000)
    ...
    time_ms = time_operation(get_class, iterations=100_000)
    ...
    time_ms = time_operation(get_class_name, iterations=100_000)
    ...
    time_ms = time_operation(get_mro, iterations=100_000)
    ...
    time_ms = time_operation(get_bases, iterations=100_000)
