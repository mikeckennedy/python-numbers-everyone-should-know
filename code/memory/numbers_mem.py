...
def run_benchmarks() -> dict:
    ...
    results.append(
        MemoryResult(name="small_int", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="boundary_int", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="large_int", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(
            name="very_large_int_20", value=size, unit="bytes", category="memory"
        )
    )
    ...
    results.append(
        MemoryResult(name="huge_int_100", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="float", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="large_float", value=size, unit="bytes", category="memory")
    )
