...
def run_benchmarks() -> dict:
    ...
    results.append(
        MemoryResult(name="empty_string", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="1_char_string", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(name="10_char_string", value=size, unit="bytes", category="memory")
    )
    ...
    results.append(
        MemoryResult(
            name="100_char_string", value=size, unit="bytes", category="memory"
        )
    )
    ...
    results.append(
        MemoryResult(
            name="1000_char_string", value=size, unit="bytes", category="memory"
        )
    )
